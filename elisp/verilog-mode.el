...
(easy-menu-define
  ...
  (verilog-easy-menu-filter
   '("Statements"
     ...
     ["Comment-End"	verilog-sk-comment-end
      :help		"Insert a end of file comment block"]
     ["Comment-Main" verilog-sk-comment-main
      :help		"Insert a main comment block"]
     ["Comment-Main" verilog-sk-comment-spliter
      :help		"Insert a spliter comment block"]
     "----"
...
Some other functions are:
    ...
    \\[verilog-sk-comment-main]  Insert a main comment block.
    \\[verilog-sk-comment-spliter]  Insert a spliter comment block.
    \\[verilog-sk-comment-end]  Insert a end of file comment block.
...
(defvar verilog-template-map
  (let ((map (make-sparse-keymap)))
    ...
    (define-key map "M" 'verilog-sk-comment-main)
    (define-key map "P" 'verilog-sk-comment-spliter)
    (define-key map "E" 'verilog-sk-comment-end)
...
(define-skeleton verilog-sk-comment-main
  "Inserts three comment lines, making a display comment."
  ()
  > "// --========================================================================--\n"
  > "// Main Description\n"
...
(define-skeleton verilog-sk-comment-spliter
  "Inserts one end of file comment, making a display comment."
  ()
  > "// --========================================================================--\n"
  > "// " _ \n
  > "// ----------------------------------------------------------------------------\n")
...
(define-skeleton verilog-sk-comment-end
  "Inserts one end of file comment, making a display comment."
  ()
  > "// --================================= End ==================================--\n"
  > "" _ \n)
